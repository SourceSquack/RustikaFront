        ...
        <div className=''>
            ...
            <div className="mt-48 sm:px-6 
                ...
                <div className="  text-zinc-900 text-center text-5xl grid gap-y-2 sm:gap-y-8">
                    <div className="  sm:row-span-4 lg:row-span-3  rounded-lg">
                        <h2 className='my-16'>SOBRE NOSOTROS</h2>
                        <p className='text-zinc-900 text-2xl'>Rústika Parrilla café-bar ubicado en la salida hacia Quimbaya, cerca al mirador, a una cuadra del hospital San Vicente de Paúl. Nos encontramos abiertos desde Abril del 2021 con nueva administración, para brindarles un servicio ameno y familiar.</p>
                        <br />
                        <p className='text-zinc-900 text-2xl'>Comprometidos con la calidad de los alimentos, los sabores, la presentación, música y bebidas con y sin licor. Con un equipo de trabajo capacitado e íntegro donde prima el buen servicio y la calidad, es un sitio remodelado totalmente, desde su estructura, concepto, menú, talento humano y administración, que busca la armonía entre un ambiente acogedor y del disfrute de todos.</p>
                    </div>
                    <div className=" sm:row-span-0 lg:row-span-1  rounded-lg">
