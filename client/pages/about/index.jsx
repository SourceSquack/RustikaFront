...
const page = () => {
    return (
        <div className='h-screen'>
            <div className={`h-1/4  text-red text-center text-5xl flex align-middle justify-center`} >
                <video muted autoPlay loop src={"/banerAbout1.mp4"} className={s.banner} />
                <Image src={banner2} alt={"banner decoration"} className={s.bannerA} />
            </div>
            <div className=" h-3/4 mt-16
                ...
                <div className=" text-white text-center text-5xl grid gap-y-3 ">
                    ...
                    <div className=" sm:row-span-0 lg:row-span-1 ">
                        <Image src={banner1} alt={"banner decoration2"} className={s.bannerB} />
                    </div>
                </div>
                <div className=" text-white text-center text-5xl">
                    <Image src={banner3} alt={"banner decoration3"} className={s.bannerC} />
                </div>
            </div>
        </div >
    );
